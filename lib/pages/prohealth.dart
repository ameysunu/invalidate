...
class Prohealth extends StatefulWidget {
  @override
  _ProhealthState createState() => _ProhealthState();
}

class _ProhealthState extends State<Prohealth> {
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: Image.asset('images/hospitals/prohealth.jpg'),
                ),
              ),
              Padding(
                padding: const EdgeInsets.fromLTRB(10, 20, 10, 0),
...
void createRecord() {
  firestoreInstance.collection("users").doc("hospi").update({
    ...
    "hospital": "Prohealth Urgent Care Of Gramercy Park New York, NY"
  }).then((value) {
    print("success");
  });
}
