...
class AdvantageCare extends StatefulWidget {
  @override
  _AdvantageCareState createState() => _AdvantageCareState();
}

class _AdvantageCareState extends State<AdvantageCare> {
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: Image.asset('images/hospitals/advantagecare.png'),
                ),
              ),
              Padding(
                padding: const EdgeInsets.fromLTRB(10, 20, 10, 0),
...
void createRecord() {
  firestoreInstance.collection("users").doc("hospi").update({
    ...
    "hospital": "AdvantageCare Physicians - East New York Medical Office"
  }).then((value) {
    print("success");
  });
}
