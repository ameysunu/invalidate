...
class Northwell extends StatefulWidget {
  @override
  _NorthwellState createState() => _NorthwellState();
}

class _NorthwellState extends State<Northwell> {
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: Image.asset('images/hospitals/northwell.jpeg'),
                ),
              ),
              Padding(
                padding: const EdgeInsets.fromLTRB(10, 20, 10, 0),
...
void createRecord() {
  firestoreInstance.collection("users").doc("hospi").update({
    ...
    "hospital": "Northwell Health-GoHealth Urgent Care New York"
  }).then((value) {
    print("success");
  });
}
